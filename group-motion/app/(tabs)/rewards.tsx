      ...
      <View style={styles.rewardContent}>
        ...
        <View style={styles.rewardMetrics}>
          ...
          <View style={styles.completionsContainer}>
            <FontAwesome5 name="users" size={12} color="#FFFFFF" style={styles.completionsIcon} />
...
export default function RewardsScreen() {
  ...
  const totalCompletions = mockRewards.reduce((sum, reward) => sum + reward.completions, 0);
          ...
          <LinearGradient
            ...
            <View style={styles.statsContainer}>
              <View style={styles.statItem}>
                <ThemedText style={styles.statNumber}>{mockRewards.length}</ThemedText>
